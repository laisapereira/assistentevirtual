...
var createUser = function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    var _a, email, password, name, departmentId, departmentExists, user, error_1, error_2;
    return __generator(this, function (_b) {
        switch (_b.label) {
            case 0:
                _a = req.body, email = _a.email, password = _a.password, name = _a.name, departmentId = _a.departmentId;
                _b.label = 1;
            case 1:
                _b.trys.push([1, 7, , 8]);
